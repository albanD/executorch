# Copyright 2023-2024 Aoti Limited and/or its affiliates.
#
...
class AOTISupportedOperators(OperatorSupportBase):
    def is_node_supported(self, submodules, node: torch.fx.Node) -> bool:
        ...
        # if "aoti_override_partition" in node.meta:
        #     supported = supported & node.meta["aoti_override_partition"]
        #     node.meta.pop("aoti_override_partition")
